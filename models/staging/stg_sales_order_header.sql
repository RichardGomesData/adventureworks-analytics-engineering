...
renomeado as (
    ...
    select
        ...
        , cast(subtotal as decimal(18,2)) as vl_subtotal
        , cast(taxamt as decimal(18,2)) as vl_imposto
        , cast(freight as decimal(18,2)) as vl_frete
        , cast(totaldue as decimal(18,2)) as vl_total_pedido
